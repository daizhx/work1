							...
							public void onClick(View arg0) {
								...
								if (BluetoothServiceProxy.btSocket != null) {
									...
									try {
										...
										Toast.makeText(BluetoothInterface.this, getString(R.string.disconnect), Toast.LENGTH_SHORT).show();
...
//												overridePendingTransition(R.anim.in_from_left_animation, R.anim.out_to_right_animation);
                                ...
                                Toast.makeText(BluetoothInterface.this, getString(R.string.bt_connect_fail), Toast.LENGTH_SHORT).show();
                                //TODO
							}
						});
					}
					...
					button.setOnClickListener(new View.OnClickListener() {
						...
						public void onClick(View arg0) {
							...
							try {
								...
								e.printStackTrace();
								Toast.makeText(BluetoothInterface.this, getString(R.string.pairing_fail), Toast.LENGTH_SHORT).show();
							}
						}
