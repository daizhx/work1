 ...
 */
public class BaseExtBTActivity extends BTActivity implements BTIndicator{
    ...
    private void showFloatWindow() {
        ...
        view.findViewById(R.id.top).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
                startActivity(new Intent(BaseExtBTActivity.this,
        ...
        view.findViewById(R.id.right).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
                startActivity(new Intent(BaseExtBTActivity.this, HealthClub.class));
                ppw.dismiss();
            }
        });
    }
